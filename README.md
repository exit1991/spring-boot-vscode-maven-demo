# 1. spring-boot-vscode-maven-demo
Spring Boot の VSCode と Maven を使用したデモ

- [1. spring-boot-vscode-maven-demo](#1-spring-boot-vscode-maven-demo)
- [2. 初期構築](#2-初期構築)
  - [2.1. 事前準備](#21-事前準備)
...
2. 以下の内容を設定し、 GENERATE ボタンで zip をダウンロードする
    - 設定内容
        ...
        - Project Metadata
            - Group : （※例：com.example）
            - Artifact : （※例：spring-boot-vscode-maven-demo）
...
- 以下の内容のファイルを作成する
- 格納ディレクトリ: `src/main/java/com/example/spring_boot_vscode_maven_demo/`
